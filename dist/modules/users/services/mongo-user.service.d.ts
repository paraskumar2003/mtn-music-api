...
export declare class MongoUsersService {
    ...
    getUserById(userId: string): Promise<import("mongoose").Document<unknown, {}, MongoUserDocument, {}, {}> & MongoUser & import("mongoose").Document<unknown, any, any, Record<string, any>, {}> & Required<{
        _id: Types.ObjectId;
    }> & {
        __v: number;
    }>;
    getUserDetailsByUserId(user_id: string): Promise<import("mongoose").Document<unknown, {}, UserDetails, {}, {}> & UserDetails & Required<{
        _id: Types.ObjectId;
    }> & {
        __v: number;
    }>;
