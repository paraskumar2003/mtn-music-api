...
const s3_interceptor_1 = require("./interceptors/s3.interceptor");
let S3Controller = class S3Controller {
    async uploadSingleImage(files) {
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, s3_interceptor_1.S3MultipleFieldsInterceptor)([{ name: 'file', maxCount: 1 }])),
    __param(0, (0, common_1.UploadedFiles)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], S3Controller.prototype, "uploadSingleImage", null);
